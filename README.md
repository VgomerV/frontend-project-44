...
Вам показывается математическое выражение, например 35 + 16, которое нужно вычислить и записать правильный ответ. 
...
Вам показывается прогрессия, необходимо определить пропущенное значение.
[![asciicast](https://asciinema.org/a/TkK6U8zcoqdk0YoRtqFq2bTed.svg)](https://asciinema.org/a/TkK6U8zcoqdk0YoRtqFq2bTed)

Игра "Простое ли число?". 

Вам показывается случайное число. Необходимо определить, простое оно или нет. Да - нужно ответить yes, нет - нужно ответить no.
