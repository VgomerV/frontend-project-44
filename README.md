...
Вам показывается два случайных числа, например, 25 50. Нужно вычислить и ввести наибольший общий делитель этих чисел.
...
Вам показывается ряд числе, образующих арифмитическую прогрессию. Необходимо определить неизвестное число.
...
Вам показывается случайное яисло. Необходимо ответить yes если чилсо простое или no если нет.
